...
const Layout: React.FC<ILayout> = ({ children, title, isAuth = false }) => {
    ...
    <div>
      ...
      <header
        className={classToString(
          "flex justify-between px-14  items-center",
          isAuth ? "bg-black py-4" : "border-b-2 py-5"
        )}
      >
        <div className="flex items-center space-x-6 ">
          ...
          >
            <g fill="none">
              ...
              ></path>
              <path
                fill={classToString(isAuth ? "#fff" : "#000")}
        ...
        {!isAuth && (
          <div className="flex items-center space-x-4">
            <div className="flex space-x-2 font-medium text-sm cursor-pointer px-2 py-2 rounded-3xl bg-black text-white hover:bg-gray-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                viewBox="0 0 20 20"
